...
export function DesktopEntryShell({
  ...
  return (
    <div className="grid min-h-full gap-6 p-6 xl:grid-cols-[0.92fr_1.08fr]">
      <section className="relative flex min-h-[720px] flex-col justify-between overflow-hidden rounded-[32px] border border-[color:var(--border-faint)] bg-[linear-gradient(145deg,rgba(255,255,255,0.99),rgba(255,247,235,0.96)_40%,rgba(239,251,245,0.98))] p-8 shadow-[var(--shadow-section)]">
        ...
        <div className="relative">
          <div className="inline-flex rounded-full border border-[rgba(255,179,71,0.24)] bg-white/88 px-3 py-1 text-[11px] uppercase tracking-[0.34em] text-[color:var(--brand-secondary)]">{badge}</div>
      ...
      <section className="flex min-h-[720px] flex-col justify-center rounded-[32px] border border-[color:var(--border-faint)] bg-[linear-gradient(180deg,rgba(255,255,255,0.96),rgba(248,252,249,0.99))] p-6 shadow-[var(--shadow-section)]">
        {children}
      </section>
    </div>
  );
