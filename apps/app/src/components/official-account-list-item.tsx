...
export function OfficialAccountListItem({
  ...
  return (
    <button
      ...
      onClick={onClick}
      className={cn(
        "flex w-full items-center gap-3 text-left transition-colors duration-[var(--motion-fast)] ease-[var(--ease-standard)]",
        compact
          ? "rounded-[20px] border border-[color:var(--border-faint)] bg-white/88 px-4 py-3 hover:bg-white"
          : "border-b border-[color:var(--border-faint)] bg-[rgba(255,249,238,0.82)] px-4 py-3 hover:bg-white/92",
