...
impl PersonalityProfile {
  pub fn bootstrap(character_id: &str, name: &str, relationship: &str, expert_domains: &[String]) -> Self {
    Self {
...
impl CharacterRecord {
  pub fn from_patch(id: String, patch: CharacterPatch) -> Self {
    ...
    let profile = patch
      .profile
      .unwrap_or_else(|| PersonalityProfile::bootstrap(&id, &name, &relationship, &expert_domains));
