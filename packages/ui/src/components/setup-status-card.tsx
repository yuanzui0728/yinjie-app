...
export function SetupStatusCard({ title, value, detail, ok, className }: SetupStatusCardProps) {
  return (
    <div className={className ?? "rounded-[26px] border border-[color:var(--border-faint)] bg-[linear-gradient(180deg,rgba(255,255,255,0.98),rgba(255,248,239,0.92))] p-4 shadow-[var(--shadow-soft)]"}>
